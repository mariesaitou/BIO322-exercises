...
1. From each of the following Ensembl genome databases, choose **at least one species** per potal.
...
2. Provide a concise description (2–3 sentences) for each species explaining what kind of organism it is and any relevant biological or ecological context. 

3. For each selected species, gather the following data:
   - Genome size
...
4. Create a figure (e.g., bar chart, scatter plot, bubble chart) that visually compares the species across the gathered metrics. 

5. Discuss the following reflective questions under the figure:
...
## ============================================================
## Gene-family simulation with an ancient duplication
## + a recent Pegasus-specific duplication (within gene1b lineage)
...
set.seed(42) # Change the number to your group number
