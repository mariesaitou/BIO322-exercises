...
gff_tbl <- read_te_gff("Atha_nestOrigPairsFinal.gff")
...
Which scenario produces a clearer separation between young and old copies in terms of divergence? Explain why the difference arises, referring to the timing of bursts and the accumulation of mutations.
