...
EU_OA (Europe), AM_OA (America), AF_OA (Africa), TR_OA (Turkey), IR_OA (Iran), CN_YNS (Yunnan), CN_WZM (Ujimqin), CN_TAN (Tan), CN_STH (Small-tailed Han), CN_PRT (Prairie Tibetan), CN_VLT (Valley Tibetan), CN_OLA (Tibetan Oula sheep), CN_HU (Hu sheep), CN_CLB (Cele Black sheep), CN_BYK (Bayinbuluke sheep) and AU_MRN (Australian Merino).
